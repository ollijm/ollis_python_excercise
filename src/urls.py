"""
The main user configurable file. The application periodically fetches each web page from the list below, and
checks the response HTTP status code and Content-Type's *startwith*.
"""
...
urls = [
    ...
    {
        "url": "http://www.google.com/someapi/expecting_no_content/expectation-fails",
